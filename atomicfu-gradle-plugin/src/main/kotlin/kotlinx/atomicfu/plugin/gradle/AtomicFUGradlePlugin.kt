    ...
    withKotlinTargets { target ->
        if (target.isJsIrTarget() && config.transformJsIr) {
            ...
            val compileOnlyTestConfigurationName = project.extensions.getByType(KotlinMultiplatformExtension::class.java).sourceSets
                .getByName("jsTest")
                .compileOnlyConfigurationName
            dependencies.add(compileOnlyConfigurationName, "org.jetbrains.kotlin:atomicfu:1.6.20-dev-3922")
            dependencies.add(compileOnlyTestConfigurationName, "org.jetbrains.kotlin:atomicfu:1.6.20-dev-3922")
        }
    }
}
